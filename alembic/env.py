...
# ... etc.
testing = config.get_main_option("testing")
postgres_host = getenv("POSTGRES_HOST", default="127.0.0.1")
...
db_arg = context.get_x_argument(as_dictionary=True).get("db", None)
if db_arg:
    postgres_dbname = db_arg
else:
    postgres_dbname = getenv("POSTGRES_DB", "aiohttp_auth")
